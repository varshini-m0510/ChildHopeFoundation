    ...
    <div className="pt-16">
      ...
      <section className="py-20 bg-gradient-to-r from-trust-blue to-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl font-bold mb-6">About Parikrama Foundation</h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Our Story */}
          <div className="mb-20">
            <h3 className="text-3xl font-bold text-charcoal text-center mb-12">Our Story</h3>
          ...
          <div className="bg-gradient-to-r from-trust-blue to-blue-700 rounded-2xl p-8 md:p-12 text-white">
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="text-center md:text-left">
                <h3 className="text-2xl font-bold mb-2">Dr. Priya Sharma</h3>
                <p className="text-blue-200 mb-4">Founder & Director</p>
                <blockquote className="text-lg leading-relaxed italic">
                  "Every child deserves a chance to dream and achieve. Through Parikrama Foundation, 
                  we're not just providing education – we're nurturing hope, building confidence, 
                  and creating pathways to brighter futures. When I see the spark in a child's eyes 
                  as they learn to read or the pride in a parent's voice when their child graduates, 
                  I'm reminded why this work is so important. Together, we can break the cycle of 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-charcoal mb-6">Our Team</h3>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h3 className="text-3xl font-bold text-charcoal mb-6">Our Values</h3>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-none shadow-lg">
              <CardContent className="p-8">
                ...
                <h4 className="text-xl font-bold text-charcoal mb-4">Integrity</h4>
            ...
            <Card className="border-none shadow-lg">
              <CardContent className="p-8">
                ...
                <h4 className="text-xl font-bold text-charcoal mb-4">Empowerment</h4>
                <p className="text-gray-600">
            ...
            <Card className="border-none shadow-lg">
              <CardContent className="p-8">
                ...
                <h4 className="text-xl font-bold text-charcoal mb-4">Compassion</h4>
                <p className="text-gray-600">
            ...
            <Card className="border-none shadow-lg">
              <CardContent className="p-8">
                ...
                <h4 className="text-xl font-bold text-charcoal mb-4">Excellence</h4>
                <p className="text-gray-600">
            ...
            <Card className="border-none shadow-lg">
              <CardContent className="p-8">
                ...
                <h4 className="text-xl font-bold text-charcoal mb-4">Inclusion</h4>
                <p className="text-gray-600">
            ...
            <Card className="border-none shadow-lg">
              <CardContent className="p-8">
                ...
                <h4 className="text-xl font-bold text-charcoal mb-4">Collaboration</h4>
                <p className="text-gray-600">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gray-50 rounded-2xl p-8 md:p-12">
            <h3 className="text-3xl font-bold text-charcoal text-center mb-8">Our Partners</h3>
